...
namespace Fsm.Infrastructure.Migrations
{
    ...
    [Migration("20230427054417_more simlification")]
    partial class moresimlification
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Fsm.Domain.Entities.Activity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Fsm.Domain.Entities.ActivityLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("Fsm.Domain.Entities.CheckLists", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("Fsm.Domain.Entities.ContactDomainRoles", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("Fsm.Domain.Entities.Documents", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("Fsm.Domain.Entities.EmploymentDetails", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("Fsm.Domain.Entities.GeneralDetails", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("Fsm.Domain.Entities.Role", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("Fsm.Domain.Entities.RoleGroup", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("Fsm.Domain.Entities.RoleObject", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("Fsm.Domain.Entities.Skills", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("Fsm.Domain.Entities.Ticket", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("Fsm.Domain.Entities.User", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("Fsm.Domain.Entities.Activity", b =>
                {
                    b.HasOne("Fsm.Domain.Entities.CheckLists", null)
            ...
            modelBuilder.Entity("Fsm.Domain.Entities.ActivityLog", b =>
                {
                    b.HasOne("Fsm.Domain.Entities.Activity", null)
                        .WithMany("TaskLog")
            ...
            modelBuilder.Entity("Fsm.Domain.Entities.CheckLists", b =>
                {
                    b.HasOne("Fsm.Domain.Entities.Ticket", null)
                        .WithMany("CheckLists")
            ...
            modelBuilder.Entity("Fsm.Domain.Entities.ContactDomainRoles", b =>
                {
                    b.HasOne("Fsm.Domain.Entities.RoleGroup", "RoleGroup1")
            ...
            modelBuilder.Entity("Fsm.Domain.Entities.Documents", b =>
                {
                    ...
                    b.HasOne("Fsm.Domain.Entities.ActivityLog", null)
            ...
            modelBuilder.Entity("Fsm.Domain.Entities.EmploymentDetails", b =>
                {
                    b.HasOne("Fsm.Domain.Entities.Ticket", "ActiveTicket1")
            ...
            modelBuilder.Entity("Fsm.Domain.Entities.RoleObject", b =>
                {
                    b.HasOne("Fsm.Domain.Entities.RoleGroup", "GroupRoleGroup")
            ...
            modelBuilder.Entity("Fsm.Domain.Entities.User", b =>
                {
                    b.HasOne("Fsm.Domain.Entities.EmploymentDetails", "EmploymentDetails1")
                        .WithOne("User")
                        .HasForeignKey("Fsm.Domain.Entities.User", "EmploymentDetails")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Fsm.Domain.Entities.GeneralDetails", "GeneralDetails")
                        .WithOne("ReferencedUser")
                        .HasForeignKey("Fsm.Domain.Entities.User", "PersonalDetails")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("FK__User__PersonalDe__5CD6CB2B");

                    b.HasOne("Fsm.Domain.Entities.Role", "Role1")
                        .WithMany("Users")
                        .HasForeignKey("Role")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired()
